...
public class CSBuyItemMsg implements org.apache.thrift.TBase<CSBuyItemMsg, CSBuyItemMsg._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSBuyItemMsg");
  ...
  private static final org.apache.thrift.protocol.TField CAL_MARK_TAG_FIELD_DESC = new org.apache.thrift.protocol.TField("calMarkTag", org.apache.thrift.protocol.TType.BYTE, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new CSBuyItemMsgStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSBuyItemMsgTupleSchemeFactory());
  }
   ...
   * 0-no 1-yes
   */
  public byte calMarkTag; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * 0-no 1-yes
     */
    CAL_MARK_TAG((short)5, "calMarkTag");
  ...
  private static final int __CALMARKTAG_ISSET_ID = 4;
  ...
  static {
    ...
    tmpMap.put(_Fields.KEY_RESULT, new org.apache.thrift.meta_data.FieldMetaData("keyResult", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
    tmpMap.put(_Fields.CAL_MARK_TAG, new org.apache.thrift.meta_data.FieldMetaData("calMarkTag", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BYTE)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSBuyItemMsg.class, metaDataMap);
  }
    ...
    byte calMarkTag)
  {
    ...
    this.calMarkTag = calMarkTag;
    setCalMarkTagIsSet(true);
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public CSBuyItemMsg(CSBuyItemMsg other) {
    ...
    this.calMarkTag = other.calMarkTag;
  }

  public CSBuyItemMsg deepCopy() {
    return new CSBuyItemMsg(this);
  }
  ...
  public CSBuyItemMsg setPartIndex(byte partIndex) {
    this.partIndex = partIndex;
    setPartIndexIsSet(true);
    return this;
  }
  ...
  public CSBuyItemMsg setInputIndex(byte inputIndex) {
    this.inputIndex = inputIndex;
    setInputIndexIsSet(true);
    return this;
  }
   ...
   * 0-male 1-female 2-together
   */
  public CSBuyItemMsg setInputType(byte inputType) {
    this.inputType = inputType;
    setInputTypeIsSet(true);
    return this;
  }
   ...
   * 1-miss 2-good 3-great 4-perfect
   */
  public CSBuyItemMsg setKeyResult(byte keyResult) {
    this.keyResult = keyResult;
    setKeyResultIsSet(true);
    return this;
  }
   ...
   * 0-no 1-yes
   */
  public byte getCalMarkTag() {
    return this.calMarkTag;
  }

  /**
   * 0-no 1-yes
   */
  public CSBuyItemMsg setCalMarkTag(byte calMarkTag) {
    this.calMarkTag = calMarkTag;
    setCalMarkTagIsSet(true);
    return this;
  }

  public void unsetCalMarkTag() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __CALMARKTAG_ISSET_ID);
  }

  /** Returns true if field calMarkTag is set (has been assigned a value) and false otherwise */
  public boolean isSetCalMarkTag() {
    return EncodingUtils.testBit(__isset_bitfield, __CALMARKTAG_ISSET_ID);
  }

  public void setCalMarkTagIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __CALMARKTAG_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case CAL_MARK_TAG:
      return Byte.valueOf(getCalMarkTag());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSBuyItemMsg)
      return this.equals((CSBuyItemMsg)that);
    return false;
  }

  public boolean equals(CSBuyItemMsg that) {
    if (that == null)
      return false;
    ...
    boolean this_present_calMarkTag = true;
    boolean that_present_calMarkTag = true;
    if (this_present_calMarkTag || that_present_calMarkTag) {
      if (!(this_present_calMarkTag && that_present_calMarkTag))
        return false;
      if (this.calMarkTag != that.calMarkTag)
        return false;
    }
  ...
  public int compareTo(CSBuyItemMsg other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSBuyItemMsg typedOther = (CSBuyItemMsg)other;
    ...
    lastComparison = Boolean.valueOf(isSetCalMarkTag()).compareTo(typedOther.isSetCalMarkTag());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCalMarkTag()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.calMarkTag, typedOther.calMarkTag);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSBuyItemMsg(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("calMarkTag:");
    sb.append(this.calMarkTag);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class CSBuyItemMsgStandardSchemeFactory implements SchemeFactory {
    public CSBuyItemMsgStandardScheme getScheme() {
      return new CSBuyItemMsgStandardScheme();
    }
  }

  private static class CSBuyItemMsgStandardScheme extends StandardScheme<CSBuyItemMsg> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSBuyItemMsg struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // CAL_MARK_TAG
            if (schemeField.type == org.apache.thrift.protocol.TType.BYTE) {
              struct.calMarkTag = iprot.readByte();
              struct.setCalMarkTagIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSBuyItemMsg struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(CAL_MARK_TAG_FIELD_DESC);
      oprot.writeByte(struct.calMarkTag);
      oprot.writeFieldEnd();
  ...
  private static class CSBuyItemMsgTupleSchemeFactory implements SchemeFactory {
    public CSBuyItemMsgTupleScheme getScheme() {
      return new CSBuyItemMsgTupleScheme();
    }
  }

  private static class CSBuyItemMsgTupleScheme extends TupleScheme<CSBuyItemMsg> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSBuyItemMsg struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSBuyItemMsg struct) throws org.apache.thrift.TException {
